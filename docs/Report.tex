...
For the comparison with the Greedy Spanner, we utilized a specialized notebook (\texttt{notebooks/04\_greedy\_comparison.ipynb}). The Greedy experiments were restricted to $n \le 1000$ because the $O(mn)$ complexity of the Greedy algorithm made it infeasible for larger dense graphs within a reasonable timeframe.
